...
<title>Alumni sign up message</title>
<link rel="stylesheet"
...
<body>
	<%
		...
		pst.setString(4, request.getParameter("company"));
		pst.setString(5, request.getParameter("city"));
		pst.setString(6, request.getParameter("email"));
		pst.setString(7, request.getParameter("contact"));
		pst.setString(8, request.getParameter("password"));
		pst.setString(9, request.getParameter("year"));
		pst.setString(10, request.getParameter("branch"));
